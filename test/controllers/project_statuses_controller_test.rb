...
class ProjectStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_status" do
    assert_difference('ProjectStatus.count') do
      post project_statuses_url, params: { project_status: { name: @project_status.name, project_id: @project_status.project_id } }
    end
  ...
  test "should update project_status" do
    patch project_status_url(@project_status), params: { project_status: { name: @project_status.name, project_id: @project_status.project_id } }
