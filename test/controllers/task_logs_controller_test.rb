...
class TaskLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_log" do
    assert_difference('TaskLog.count') do
      post task_logs_url, params: { task_log: { content: @task_log.content, task_id: @task_log.task_id, title: @task_log.title, user_id: @task_log.user_id } }
    end
  ...
  test "should update task_log" do
    patch task_log_url(@task_log), params: { task_log: { content: @task_log.content, task_id: @task_log.task_id, title: @task_log.title, user_id: @task_log.user_id } }
