...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { component_id: @worker.component_id, user_id: @worker.user_id } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { component_id: @worker.component_id, user_id: @worker.user_id } }
